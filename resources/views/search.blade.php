...
<form action="{{ route('providers.index') }}" method="GET">
    <div class="form-group">
        ...
        <input type="number" id="experience" name="experience" class="form-control" placeholder="أدخل الحد الأدنى لسنوات الخبرة">
        <label for="age">العمر</label>
        <input type="number" id="age" name="age" class="form-control" placeholder="أدخل الحد الأدنى للعمر">
    </div>
    <div class="form-group">
